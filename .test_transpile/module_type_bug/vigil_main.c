...
static const char vigil_path_0[] = "examples/test_programs/module_type_bug/main.vigil";
static const char vigil_src_1[] = "pub class MyClass {\n    pub string value\n    fn init() -> void {\n        self.value = \"hello\"\n    }\n\n}\n";
static const char vigil_path_1[] = "examples/test_programs/module_type_bug/mymodule.vigil";
...
int main(void)
{
    ...
    { vigil_source_id_t _id = 0;
      ...
      if (0 == 0) sid = _id; }
    { vigil_source_id_t _id = 0;
      vigil_source_registry_register_cstr(&registry, vigil_path_1, vigil_src_1, &_id, &error);
      if (1 == 0) sid = _id; }
