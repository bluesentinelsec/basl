...
#define SDL_NATIVE_CONST(vname, value)                                                                                 \
    {                                                                                                                  \
        vname, sizeof(vname) - 1U, VIGIL_TYPE_I32, (int64_t)(int32_t)(value), 0.0, NULL                               \
    }
...
static const vigil_native_module_constant_t sdl_constants[] = {
    SDL_NATIVE_CONST("INIT_AUDIO", SDL_INIT_AUDIO),
    SDL_NATIVE_CONST("INIT_VIDEO", SDL_INIT_VIDEO),
    SDL_NATIVE_CONST("INIT_JOYSTICK", SDL_INIT_JOYSTICK),
    SDL_NATIVE_CONST("INIT_HAPTIC", SDL_INIT_HAPTIC),
    SDL_NATIVE_CONST("INIT_GAMEPAD", SDL_INIT_GAMEPAD),
    SDL_NATIVE_CONST("INIT_EVENTS", SDL_INIT_EVENTS),
    SDL_NATIVE_CONST("INIT_SENSOR", SDL_INIT_SENSOR),
    SDL_NATIVE_CONST("INIT_CAMERA", SDL_INIT_CAMERA),
    SDL_NATIVE_CONST("WINDOW_FULLSCREEN", SDL_WINDOW_FULLSCREEN),
    SDL_NATIVE_CONST("WINDOW_OPENGL", SDL_WINDOW_OPENGL),
    SDL_NATIVE_CONST("WINDOW_HIDDEN", SDL_WINDOW_HIDDEN),
    SDL_NATIVE_CONST("WINDOW_BORDERLESS", SDL_WINDOW_BORDERLESS),
    SDL_NATIVE_CONST("WINDOW_RESIZABLE", SDL_WINDOW_RESIZABLE),
    SDL_NATIVE_CONST("WINDOW_MINIMIZED", SDL_WINDOW_MINIMIZED),
    SDL_NATIVE_CONST("WINDOW_MAXIMIZED", SDL_WINDOW_MAXIMIZED),
    SDL_NATIVE_CONST("WINDOW_ALWAYS_ON_TOP", SDL_WINDOW_ALWAYS_ON_TOP),
    SDL_NATIVE_CONST("WINDOW_VULKAN", SDL_WINDOW_VULKAN),
    SDL_NATIVE_CONST("WINDOW_METAL", SDL_WINDOW_METAL),
    SDL_NATIVE_CONST("WINDOW_HIGH_PIXEL_DENSITY", SDL_WINDOW_HIGH_PIXEL_DENSITY),
    SDL_NATIVE_CONST("EVENT_QUIT", SDL_EVENT_QUIT),
    SDL_NATIVE_CONST("EVENT_KEY_DOWN", SDL_EVENT_KEY_DOWN),
    SDL_NATIVE_CONST("EVENT_KEY_UP", SDL_EVENT_KEY_UP),
    SDL_NATIVE_CONST("EVENT_MOUSE_MOTION", SDL_EVENT_MOUSE_MOTION),
    SDL_NATIVE_CONST("EVENT_MOUSE_BUTTON_DOWN", SDL_EVENT_MOUSE_BUTTON_DOWN),
    SDL_NATIVE_CONST("EVENT_MOUSE_BUTTON_UP", SDL_EVENT_MOUSE_BUTTON_UP),
    SDL_NATIVE_CONST("EVENT_MOUSE_WHEEL", SDL_EVENT_MOUSE_WHEEL),
    SDL_NATIVE_CONST("EVENT_WINDOW_CLOSE_REQUESTED", SDL_EVENT_WINDOW_CLOSE_REQUESTED),
    SDL_NATIVE_CONST("EVENT_WINDOW_RESIZED", SDL_EVENT_WINDOW_RESIZED),
    SDL_NATIVE_CONST("SCANCODE_A", SDL_SCANCODE_A),
    SDL_NATIVE_CONST("SCANCODE_B", SDL_SCANCODE_B),
    SDL_NATIVE_CONST("SCANCODE_C", SDL_SCANCODE_C),
    SDL_NATIVE_CONST("SCANCODE_D", SDL_SCANCODE_D),
    SDL_NATIVE_CONST("SCANCODE_E", SDL_SCANCODE_E),
    SDL_NATIVE_CONST("SCANCODE_F", SDL_SCANCODE_F),
    SDL_NATIVE_CONST("SCANCODE_G", SDL_SCANCODE_G),
    SDL_NATIVE_CONST("SCANCODE_H", SDL_SCANCODE_H),
    SDL_NATIVE_CONST("SCANCODE_I", SDL_SCANCODE_I),
    SDL_NATIVE_CONST("SCANCODE_J", SDL_SCANCODE_J),
    SDL_NATIVE_CONST("SCANCODE_K", SDL_SCANCODE_K),
    SDL_NATIVE_CONST("SCANCODE_L", SDL_SCANCODE_L),
    SDL_NATIVE_CONST("SCANCODE_M", SDL_SCANCODE_M),
    SDL_NATIVE_CONST("SCANCODE_N", SDL_SCANCODE_N),
    SDL_NATIVE_CONST("SCANCODE_O", SDL_SCANCODE_O),
    SDL_NATIVE_CONST("SCANCODE_P", SDL_SCANCODE_P),
    SDL_NATIVE_CONST("SCANCODE_Q", SDL_SCANCODE_Q),
    SDL_NATIVE_CONST("SCANCODE_R", SDL_SCANCODE_R),
    SDL_NATIVE_CONST("SCANCODE_S", SDL_SCANCODE_S),
    SDL_NATIVE_CONST("SCANCODE_T", SDL_SCANCODE_T),
    SDL_NATIVE_CONST("SCANCODE_U", SDL_SCANCODE_U),
    SDL_NATIVE_CONST("SCANCODE_V", SDL_SCANCODE_V),
    SDL_NATIVE_CONST("SCANCODE_W", SDL_SCANCODE_W),
    SDL_NATIVE_CONST("SCANCODE_X", SDL_SCANCODE_X),
    SDL_NATIVE_CONST("SCANCODE_Y", SDL_SCANCODE_Y),
    SDL_NATIVE_CONST("SCANCODE_Z", SDL_SCANCODE_Z),
    SDL_NATIVE_CONST("SCANCODE_0", SDL_SCANCODE_0),
    SDL_NATIVE_CONST("SCANCODE_1", SDL_SCANCODE_1),
    SDL_NATIVE_CONST("SCANCODE_2", SDL_SCANCODE_2),
    SDL_NATIVE_CONST("SCANCODE_3", SDL_SCANCODE_3),
    SDL_NATIVE_CONST("SCANCODE_4", SDL_SCANCODE_4),
    SDL_NATIVE_CONST("SCANCODE_5", SDL_SCANCODE_5),
    SDL_NATIVE_CONST("SCANCODE_6", SDL_SCANCODE_6),
    SDL_NATIVE_CONST("SCANCODE_7", SDL_SCANCODE_7),
    SDL_NATIVE_CONST("SCANCODE_8", SDL_SCANCODE_8),
    SDL_NATIVE_CONST("SCANCODE_9", SDL_SCANCODE_9),
    SDL_NATIVE_CONST("SCANCODE_RETURN", SDL_SCANCODE_RETURN),
    SDL_NATIVE_CONST("SCANCODE_ESCAPE", SDL_SCANCODE_ESCAPE),
    SDL_NATIVE_CONST("SCANCODE_BACKSPACE", SDL_SCANCODE_BACKSPACE),
    SDL_NATIVE_CONST("SCANCODE_TAB", SDL_SCANCODE_TAB),
    SDL_NATIVE_CONST("SCANCODE_SPACE", SDL_SCANCODE_SPACE),
    SDL_NATIVE_CONST("SCANCODE_RIGHT", SDL_SCANCODE_RIGHT),
    SDL_NATIVE_CONST("SCANCODE_LEFT", SDL_SCANCODE_LEFT),
    SDL_NATIVE_CONST("SCANCODE_DOWN", SDL_SCANCODE_DOWN),
    SDL_NATIVE_CONST("SCANCODE_UP", SDL_SCANCODE_UP),
    SDL_NATIVE_CONST("SCANCODE_DELETE", SDL_SCANCODE_DELETE),
    SDL_NATIVE_CONST("SCANCODE_LCTRL", SDL_SCANCODE_LCTRL),
    SDL_NATIVE_CONST("SCANCODE_LSHIFT", SDL_SCANCODE_LSHIFT),
    SDL_NATIVE_CONST("SCANCODE_LALT", SDL_SCANCODE_LALT),
    SDL_NATIVE_CONST("SCANCODE_RCTRL", SDL_SCANCODE_RCTRL),
    SDL_NATIVE_CONST("SCANCODE_RSHIFT", SDL_SCANCODE_RSHIFT),
    SDL_NATIVE_CONST("SCANCODE_RALT", SDL_SCANCODE_RALT),
    SDL_NATIVE_CONST("SCANCODE_F1", SDL_SCANCODE_F1),
    SDL_NATIVE_CONST("SCANCODE_F2", SDL_SCANCODE_F2),
    SDL_NATIVE_CONST("SCANCODE_F3", SDL_SCANCODE_F3),
    SDL_NATIVE_CONST("SCANCODE_F4", SDL_SCANCODE_F4),
    SDL_NATIVE_CONST("SCANCODE_F5", SDL_SCANCODE_F5),
    SDL_NATIVE_CONST("SCANCODE_F6", SDL_SCANCODE_F6),
    SDL_NATIVE_CONST("SCANCODE_F7", SDL_SCANCODE_F7),
    SDL_NATIVE_CONST("SCANCODE_F8", SDL_SCANCODE_F8),
    SDL_NATIVE_CONST("SCANCODE_F9", SDL_SCANCODE_F9),
    SDL_NATIVE_CONST("SCANCODE_F10", SDL_SCANCODE_F10),
    SDL_NATIVE_CONST("SCANCODE_F11", SDL_SCANCODE_F11),
    SDL_NATIVE_CONST("SCANCODE_F12", SDL_SCANCODE_F12),
    SDL_NATIVE_CONST("KEY_RETURN", SDLK_RETURN),
    SDL_NATIVE_CONST("KEY_ESCAPE", SDLK_ESCAPE),
    SDL_NATIVE_CONST("KEY_BACKSPACE", SDLK_BACKSPACE),
    SDL_NATIVE_CONST("KEY_TAB", SDLK_TAB),
    SDL_NATIVE_CONST("KEY_SPACE", SDLK_SPACE),
    SDL_NATIVE_CONST("KEY_DELETE", SDLK_DELETE),
    SDL_NATIVE_CONST("BUTTON_LEFT", SDL_BUTTON_LEFT),
    SDL_NATIVE_CONST("BUTTON_MIDDLE", SDL_BUTTON_MIDDLE),
    SDL_NATIVE_CONST("BUTTON_RIGHT", SDL_BUTTON_RIGHT),
    SDL_NATIVE_CONST("BUTTON_X1", SDL_BUTTON_X1),
    SDL_NATIVE_CONST("BUTTON_X2", SDL_BUTTON_X2),
    SDL_NATIVE_CONST("TEXTUREACCESS_STATIC", SDL_TEXTUREACCESS_STATIC),
    SDL_NATIVE_CONST("TEXTUREACCESS_STREAMING", SDL_TEXTUREACCESS_STREAMING),
    SDL_NATIVE_CONST("TEXTUREACCESS_TARGET", SDL_TEXTUREACCESS_TARGET),
    SDL_NATIVE_CONST("BLENDMODE_NONE", SDL_BLENDMODE_NONE),
    SDL_NATIVE_CONST("BLENDMODE_BLEND", SDL_BLENDMODE_BLEND),
    SDL_NATIVE_CONST("BLENDMODE_ADD", SDL_BLENDMODE_ADD),
    SDL_NATIVE_CONST("BLENDMODE_MOD", SDL_BLENDMODE_MOD),
    SDL_NATIVE_CONST("BLENDMODE_MUL", SDL_BLENDMODE_MUL),
    SDL_NATIVE_CONST("FLIP_NONE", SDL_FLIP_NONE),
    SDL_NATIVE_CONST("FLIP_HORIZONTAL", SDL_FLIP_HORIZONTAL),
    SDL_NATIVE_CONST("FLIP_VERTICAL", SDL_FLIP_VERTICAL),
    SDL_NATIVE_CONST("AUDIO_S16", SDL_AUDIO_S16),
    SDL_NATIVE_CONST("AUDIO_S32", SDL_AUDIO_S32),
    SDL_NATIVE_CONST("AUDIO_F32", SDL_AUDIO_F32),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_LEFTX", SDL_GAMEPAD_AXIS_LEFTX),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_LEFTY", SDL_GAMEPAD_AXIS_LEFTY),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_RIGHTX", SDL_GAMEPAD_AXIS_RIGHTX),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_RIGHTY", SDL_GAMEPAD_AXIS_RIGHTY),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_LEFT_TRIGGER", SDL_GAMEPAD_AXIS_LEFT_TRIGGER),
    SDL_NATIVE_CONST("GAMEPAD_AXIS_RIGHT_TRIGGER", SDL_GAMEPAD_AXIS_RIGHT_TRIGGER),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_SOUTH", SDL_GAMEPAD_BUTTON_SOUTH),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_EAST", SDL_GAMEPAD_BUTTON_EAST),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_WEST", SDL_GAMEPAD_BUTTON_WEST),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_NORTH", SDL_GAMEPAD_BUTTON_NORTH),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_BACK", SDL_GAMEPAD_BUTTON_BACK),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_GUIDE", SDL_GAMEPAD_BUTTON_GUIDE),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_START", SDL_GAMEPAD_BUTTON_START),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_LEFT_STICK", SDL_GAMEPAD_BUTTON_LEFT_STICK),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_RIGHT_STICK", SDL_GAMEPAD_BUTTON_RIGHT_STICK),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_LEFT_SHOULDER", SDL_GAMEPAD_BUTTON_LEFT_SHOULDER),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_RIGHT_SHOULDER", SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_DPAD_UP", SDL_GAMEPAD_BUTTON_DPAD_UP),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_DPAD_DOWN", SDL_GAMEPAD_BUTTON_DPAD_DOWN),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_DPAD_LEFT", SDL_GAMEPAD_BUTTON_DPAD_LEFT),
    SDL_NATIVE_CONST("GAMEPAD_BUTTON_DPAD_RIGHT", SDL_GAMEPAD_BUTTON_DPAD_RIGHT),
    SDL_NATIVE_CONST("EVENT_GAMEPAD_AXIS_MOTION", SDL_EVENT_GAMEPAD_AXIS_MOTION),
    SDL_NATIVE_CONST("EVENT_GAMEPAD_BUTTON_DOWN", SDL_EVENT_GAMEPAD_BUTTON_DOWN),
    SDL_NATIVE_CONST("EVENT_GAMEPAD_BUTTON_UP", SDL_EVENT_GAMEPAD_BUTTON_UP),
    SDL_NATIVE_CONST("EVENT_GAMEPAD_ADDED", SDL_EVENT_GAMEPAD_ADDED),
    SDL_NATIVE_CONST("EVENT_GAMEPAD_REMOVED", SDL_EVENT_GAMEPAD_REMOVED),
    SDL_NATIVE_CONST("MESSAGEBOX_ERROR", SDL_MESSAGEBOX_ERROR),
    SDL_NATIVE_CONST("MESSAGEBOX_WARNING", SDL_MESSAGEBOX_WARNING),
    SDL_NATIVE_CONST("MESSAGEBOX_INFORMATION", SDL_MESSAGEBOX_INFORMATION),
    SDL_NATIVE_CONST("MESSAGEBOX_BUTTONS_LEFT_TO_RIGHT", SDL_MESSAGEBOX_BUTTONS_LEFT_TO_RIGHT),
    SDL_NATIVE_CONST("MESSAGEBOX_BUTTONS_RIGHT_TO_LEFT", SDL_MESSAGEBOX_BUTTONS_RIGHT_TO_LEFT),
    SDL_NATIVE_CONST("MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT", SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT),
    SDL_NATIVE_CONST("MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT", SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT),
    SDL_NATIVE_CONST("FLASH_CANCEL", SDL_FLASH_CANCEL),
    SDL_NATIVE_CONST("FLASH_BRIEFLY", SDL_FLASH_BRIEFLY),
    SDL_NATIVE_CONST("FLASH_UNTIL_FOCUSED", SDL_FLASH_UNTIL_FOCUSED),
    SDL_NATIVE_CONST("CURSOR_DEFAULT", SDL_SYSTEM_CURSOR_DEFAULT),
    SDL_NATIVE_CONST("CURSOR_TEXT", SDL_SYSTEM_CURSOR_TEXT),
    SDL_NATIVE_CONST("CURSOR_WAIT", SDL_SYSTEM_CURSOR_WAIT),
    SDL_NATIVE_CONST("CURSOR_CROSSHAIR", SDL_SYSTEM_CURSOR_CROSSHAIR),
    SDL_NATIVE_CONST("CURSOR_PROGRESS", SDL_SYSTEM_CURSOR_PROGRESS),
    SDL_NATIVE_CONST("CURSOR_NWSE_RESIZE", SDL_SYSTEM_CURSOR_NWSE_RESIZE),
    SDL_NATIVE_CONST("CURSOR_NESW_RESIZE", SDL_SYSTEM_CURSOR_NESW_RESIZE),
    SDL_NATIVE_CONST("CURSOR_EW_RESIZE", SDL_SYSTEM_CURSOR_EW_RESIZE),
    SDL_NATIVE_CONST("CURSOR_NS_RESIZE", SDL_SYSTEM_CURSOR_NS_RESIZE),
    SDL_NATIVE_CONST("CURSOR_MOVE", SDL_SYSTEM_CURSOR_MOVE),
    SDL_NATIVE_CONST("CURSOR_NOT_ALLOWED", SDL_SYSTEM_CURSOR_NOT_ALLOWED),
    SDL_NATIVE_CONST("CURSOR_POINTER", SDL_SYSTEM_CURSOR_POINTER),
    SDL_NATIVE_CONST("SCALEMODE_NEAREST", SDL_SCALEMODE_NEAREST),
    SDL_NATIVE_CONST("SCALEMODE_LINEAR", SDL_SCALEMODE_LINEAR),
    SDL_NATIVE_CONST("SYSTEM_THEME_UNKNOWN", SDL_SYSTEM_THEME_UNKNOWN),
    SDL_NATIVE_CONST("SYSTEM_THEME_LIGHT", SDL_SYSTEM_THEME_LIGHT),
    SDL_NATIVE_CONST("SYSTEM_THEME_DARK", SDL_SYSTEM_THEME_DARK),
    SDL_NATIVE_CONST("FOLDER_HOME", SDL_FOLDER_HOME),
    SDL_NATIVE_CONST("FOLDER_DESKTOP", SDL_FOLDER_DESKTOP),
    SDL_NATIVE_CONST("FOLDER_DOCUMENTS", SDL_FOLDER_DOCUMENTS),
    SDL_NATIVE_CONST("FOLDER_DOWNLOADS", SDL_FOLDER_DOWNLOADS),
    SDL_NATIVE_CONST("FOLDER_MUSIC", SDL_FOLDER_MUSIC),
    SDL_NATIVE_CONST("FOLDER_PICTURES", SDL_FOLDER_PICTURES),
    SDL_NATIVE_CONST("FOLDER_SAVEDGAMES", SDL_FOLDER_SAVEDGAMES),
    SDL_NATIVE_CONST("FOLDER_SCREENSHOTS", SDL_FOLDER_SCREENSHOTS),
    SDL_NATIVE_CONST("FOLDER_VIDEOS", SDL_FOLDER_VIDEOS),
    SDL_NATIVE_CONST("PROGRESS_NONE", SDL_PROGRESS_STATE_NONE),
    SDL_NATIVE_CONST("PROGRESS_INDETERMINATE", SDL_PROGRESS_STATE_INDETERMINATE),
    SDL_NATIVE_CONST("PROGRESS_NORMAL", SDL_PROGRESS_STATE_NORMAL),
    SDL_NATIVE_CONST("PROGRESS_PAUSED", SDL_PROGRESS_STATE_PAUSED),
    SDL_NATIVE_CONST("PROGRESS_ERROR", SDL_PROGRESS_STATE_ERROR),
    SDL_NATIVE_CONST("HAT_CENTERED", SDL_HAT_CENTERED),
    SDL_NATIVE_CONST("HAT_UP", SDL_HAT_UP),
    SDL_NATIVE_CONST("HAT_RIGHT", SDL_HAT_RIGHT),
    SDL_NATIVE_CONST("HAT_DOWN", SDL_HAT_DOWN),
    SDL_NATIVE_CONST("HAT_LEFT", SDL_HAT_LEFT),
    SDL_NATIVE_CONST("PATHTYPE_NONE", SDL_PATHTYPE_NONE),
    SDL_NATIVE_CONST("PATHTYPE_FILE", SDL_PATHTYPE_FILE),
    SDL_NATIVE_CONST("PATHTYPE_DIRECTORY", SDL_PATHTYPE_DIRECTORY),
    SDL_NATIVE_CONST("SENSOR_ACCEL", SDL_SENSOR_ACCEL),
    SDL_NATIVE_CONST("SENSOR_GYRO", SDL_SENSOR_GYRO),
    SDL_NATIVE_CONST("SENSOR_ACCEL_L", SDL_SENSOR_ACCEL_L),
    SDL_NATIVE_CONST("SENSOR_GYRO_L", SDL_SENSOR_GYRO_L),
    SDL_NATIVE_CONST("SENSOR_ACCEL_R", SDL_SENSOR_ACCEL_R),
    SDL_NATIVE_CONST("SENSOR_GYRO_R", SDL_SENSOR_GYRO_R),
    SDL_NATIVE_CONST("IO_SEEK_SET", SDL_IO_SEEK_SET),
    SDL_NATIVE_CONST("IO_SEEK_CUR", SDL_IO_SEEK_CUR),
    SDL_NATIVE_CONST("IO_SEEK_END", SDL_IO_SEEK_END),
    SDL_NATIVE_CONST("IO_STATUS_READY", SDL_IO_STATUS_READY),
    SDL_NATIVE_CONST("IO_STATUS_ERROR", SDL_IO_STATUS_ERROR),
    SDL_NATIVE_CONST("IO_STATUS_EOF", SDL_IO_STATUS_EOF),
    SDL_NATIVE_CONST("TEXTURE_ADDRESS_AUTO", SDL_TEXTURE_ADDRESS_AUTO),
    SDL_NATIVE_CONST("TEXTURE_ADDRESS_CLAMP", SDL_TEXTURE_ADDRESS_CLAMP),
    SDL_NATIVE_CONST("TEXTURE_ADDRESS_WRAP", SDL_TEXTURE_ADDRESS_WRAP),
    SDL_NATIVE_CONST("HITTEST_NORMAL", SDL_HITTEST_NORMAL),
    SDL_NATIVE_CONST("HITTEST_DRAGGABLE", SDL_HITTEST_DRAGGABLE),
    SDL_NATIVE_CONST("HITTEST_RESIZE_TOPLEFT", SDL_HITTEST_RESIZE_TOPLEFT),
    SDL_NATIVE_CONST("HITTEST_RESIZE_TOP", SDL_HITTEST_RESIZE_TOP),
    SDL_NATIVE_CONST("HITTEST_RESIZE_TOPRIGHT", SDL_HITTEST_RESIZE_TOPRIGHT),
    SDL_NATIVE_CONST("HITTEST_RESIZE_RIGHT", SDL_HITTEST_RESIZE_RIGHT),
    SDL_NATIVE_CONST("HITTEST_RESIZE_BOTTOMRIGHT", SDL_HITTEST_RESIZE_BOTTOMRIGHT),
    SDL_NATIVE_CONST("HITTEST_RESIZE_BOTTOM", SDL_HITTEST_RESIZE_BOTTOM),
    SDL_NATIVE_CONST("HITTEST_RESIZE_BOTTOMLEFT", SDL_HITTEST_RESIZE_BOTTOMLEFT),
    SDL_NATIVE_CONST("HITTEST_RESIZE_LEFT", SDL_HITTEST_RESIZE_LEFT),
    SDL_NATIVE_CONST("GPU_SHADERFORMAT_SPIRV", SDL_GPU_SHADERFORMAT_SPIRV),
    SDL_NATIVE_CONST("GPU_SHADERFORMAT_MSL", SDL_GPU_SHADERFORMAT_MSL),
    SDL_NATIVE_CONST("GPU_SHADERFORMAT_METALLIB", SDL_GPU_SHADERFORMAT_METALLIB),
    SDL_NATIVE_CONST("GPU_SHADERSTAGE_VERTEX", SDL_GPU_SHADERSTAGE_VERTEX),
    SDL_NATIVE_CONST("GPU_SHADERSTAGE_FRAGMENT", SDL_GPU_SHADERSTAGE_FRAGMENT),
    SDL_NATIVE_CONST("GPU_PRIMITIVETYPE_TRIANGLELIST", SDL_GPU_PRIMITIVETYPE_TRIANGLELIST),
    SDL_NATIVE_CONST("GPU_PRIMITIVETYPE_TRIANGLESTRIP", SDL_GPU_PRIMITIVETYPE_TRIANGLESTRIP),
    SDL_NATIVE_CONST("GPU_PRIMITIVETYPE_LINELIST", SDL_GPU_PRIMITIVETYPE_LINELIST),
    SDL_NATIVE_CONST("GPU_PRIMITIVETYPE_LINESTRIP", SDL_GPU_PRIMITIVETYPE_LINESTRIP),
    SDL_NATIVE_CONST("GPU_PRIMITIVETYPE_POINTLIST", SDL_GPU_PRIMITIVETYPE_POINTLIST),
    SDL_NATIVE_CONST("GPU_LOADOP_LOAD", SDL_GPU_LOADOP_LOAD),
    SDL_NATIVE_CONST("GPU_LOADOP_CLEAR", SDL_GPU_LOADOP_CLEAR),
    SDL_NATIVE_CONST("GPU_LOADOP_DONT_CARE", SDL_GPU_LOADOP_DONT_CARE),
    SDL_NATIVE_CONST("GPU_STOREOP_STORE", SDL_GPU_STOREOP_STORE),
    SDL_NATIVE_CONST("GPU_STOREOP_DONT_CARE", SDL_GPU_STOREOP_DONT_CARE),
    SDL_NATIVE_CONST("GPU_BUFFERUSAGE_VERTEX", SDL_GPU_BUFFERUSAGE_VERTEX),
    SDL_NATIVE_CONST("GPU_BUFFERUSAGE_INDEX", SDL_GPU_BUFFERUSAGE_INDEX),
    SDL_NATIVE_CONST("GPU_XFER_UPLOAD", SDL_GPU_TRANSFERBUFFERUSAGE_UPLOAD),
    SDL_NATIVE_CONST("GPU_XFER_DOWNLOAD", SDL_GPU_TRANSFERBUFFERUSAGE_DOWNLOAD),
    SDL_NATIVE_CONST("GPU_VERTEXFORMAT_FLOAT2", SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2),
    SDL_NATIVE_CONST("GPU_VERTEXFORMAT_FLOAT3", SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3),
    SDL_NATIVE_CONST("GPU_VERTEXFORMAT_FLOAT4", SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4),
    SDL_NATIVE_CONST("GPU_VERTEXFORMAT_UBYTE4_NORM", SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM),
    SDL_NATIVE_CONST("GPU_TEXTUREUSAGE_SAMPLER", SDL_GPU_TEXTUREUSAGE_SAMPLER),
    SDL_NATIVE_CONST("GPU_TEXTUREUSAGE_COLOR_TARGET", SDL_GPU_TEXTUREUSAGE_COLOR_TARGET),
    SDL_NATIVE_CONST("GPU_TEXTURETYPE_2D", SDL_GPU_TEXTURETYPE_2D),
    SDL_NATIVE_CONST("GPU_SAMPLECOUNT_1", SDL_GPU_SAMPLECOUNT_1),
    SDL_NATIVE_CONST("GPU_SAMPLECOUNT_4", SDL_GPU_SAMPLECOUNT_4),
    SDL_NATIVE_CONST("GPU_FILTER_NEAREST", SDL_GPU_FILTER_NEAREST),
    SDL_NATIVE_CONST("GPU_FILTER_LINEAR", SDL_GPU_FILTER_LINEAR),
    SDL_NATIVE_CONST("GPU_SAMPLERADDRESSMODE_REPEAT", SDL_GPU_SAMPLERADDRESSMODE_REPEAT),
    SDL_NATIVE_CONST("GPU_SAMPLERADDRESSMODE_CLAMP", SDL_GPU_SAMPLERADDRESSMODE_CLAMP_TO_EDGE),
    SDL_NATIVE_CONST("GPU_INDEXELEMENTSIZE_16", SDL_GPU_INDEXELEMENTSIZE_16BIT),
    SDL_NATIVE_CONST("GPU_INDEXELEMENTSIZE_32", SDL_GPU_INDEXELEMENTSIZE_32BIT),
    SDL_NATIVE_CONST("GPU_PRESENTMODE_VSYNC", SDL_GPU_PRESENTMODE_VSYNC),
    SDL_NATIVE_CONST("GPU_PRESENTMODE_IMMEDIATE", SDL_GPU_PRESENTMODE_IMMEDIATE),
    SDL_NATIVE_CONST("GPU_PRESENTMODE_MAILBOX", SDL_GPU_PRESENTMODE_MAILBOX),
    SDL_NATIVE_CONST("GPU_SWAPCHAIN_SDR", SDL_GPU_SWAPCHAINCOMPOSITION_SDR),
    SDL_NATIVE_CONST("LOGICAL_DISABLED", SDL_LOGICAL_PRESENTATION_DISABLED),
    SDL_NATIVE_CONST("LOGICAL_STRETCH", SDL_LOGICAL_PRESENTATION_STRETCH),
    SDL_NATIVE_CONST("LOGICAL_LETTERBOX", SDL_LOGICAL_PRESENTATION_LETTERBOX),
    SDL_NATIVE_CONST("LOGICAL_OVERSCAN", SDL_LOGICAL_PRESENTATION_OVERSCAN),
    SDL_NATIVE_CONST("LOGICAL_INTEGER_SCALE", SDL_LOGICAL_PRESENTATION_INTEGER_SCALE),
};
