...
static void write_transpile_header(char *buf, size_t buf_size, size_t entry_idx, size_t arity)
{
    ...
    snprintf(buf, buf_size,
             ...
             "#include <stdint.h>\n"
             "typedef union vigil_reg { int64_t i; double f; } vigil_reg_t;\n"
             "vigil_reg_t vigil_fn_%zu(void);\n"
             "#endif\n",
             entry_idx);
}

static void write_transpile_main(char *buf, size_t buf_size, size_t entry_idx)
{
    snprintf(buf, buf_size,
             "/* Generated by vigil transpile — do not edit. */\n"
             ...
             "int main(void)\n"
             "{\n"
             "    vigil_reg_t result = vigil_fn_%zu();\n"
             "    return (int)result.i;\n"
             "}\n",
             entry_idx);
}
