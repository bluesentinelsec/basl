...
static const vigil_native_module_function_t json_functions[] = {
    {"encode", 6U, json_encode_fn, 1U, obj_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL, 0U, NULL, NULL, NULL, NULL},
...
static const vigil_native_class_method_t json_value_methods[] = {
    {"parse", 5U, json_value_parse, 1U, str_param, VIGIL_TYPE_OBJECT, 2U, obj_err_returns, 1, "Value", 5U, 0, NULL,
     NULL, NULL, NULL},
    {"read", 4U, json_value_read, 1U, str_param, VIGIL_TYPE_OBJECT, 2U, obj_err_returns, 1, "Value", 5U, 0, NULL,
     NULL, NULL, NULL},
    ...
    {"as_string", 9U, json_value_as_string, 0U, NULL, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, 0U, 0, NULL,
     NULL, NULL, NULL},
    {"at", 2U, json_value_at, 1U, i32_param, VIGIL_TYPE_OBJECT, 2U, obj_err_returns, 0, NULL, 0U, 0, NULL, NULL,
     NULL, NULL},
    {"get", 3U, json_value_get, 1U, str_param, VIGIL_TYPE_OBJECT, 2U, obj_err_returns, 0, NULL, 0U, 0, NULL, NULL,
     NULL, NULL},
    ...
    {"keys", 4U, json_value_keys, 0U, NULL, VIGIL_TYPE_OBJECT, 1U, NULL, 0, NULL, 0U, VIGIL_TYPE_STRING, NULL, NULL,
     NULL, NULL},
    {"stringify", 9U, json_value_stringify, 0U, NULL, VIGIL_TYPE_STRING, 1U, NULL, 0, NULL, 0U, 0, NULL, NULL,
     NULL, NULL},
...
VIGIL_API const vigil_native_module_t vigil_stdlib_json = {
    ...
    json_classes,   sizeof(json_classes) / sizeof(json_classes[0]), NULL};
