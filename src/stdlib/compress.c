...
static const vigil_native_module_function_t compress_functions[] = {
    ...
    {"deflate_decompress", 18U, deflate_decompress_fn, 1U, bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL,
     NULL, 0U, compress_data_param_names, NULL, NULL, &vigil_compress_deflate_decompress_doc},
    ...
    {"zlib_compress", 13U, zlib_compress_fn, 1U, bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL, 0U,
    ...
    {"zlib_decompress", 15U, zlib_decompress_fn, 1U, bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL,
     0U, compress_data_param_names, NULL, NULL, &vigil_compress_zlib_decompress_doc},
    {"zlib_decompress_max", 19U, zlib_decompress_max_fn, 2U, bytes_int_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0,
     NULL, NULL, 0U, compress_data_max_bytes_param_names, NULL, NULL, &vigil_compress_zlib_decompress_max_doc},
    {"gzip_compress", 13U, gzip_compress_fn, 1U, bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL, 0U,
     compress_data_param_names, NULL, NULL, &vigil_compress_gzip_compress_doc},
    {"gzip_compress_level", 19U, gzip_compress_level_fn, 2U, bytes_int_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0,
     NULL, NULL, 0U, compress_data_level_param_names, NULL, NULL, &vigil_compress_gzip_compress_level_doc},
    {"gzip_decompress", 15U, gzip_decompress_fn, 1U, bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL,
     0U, compress_data_param_names, NULL, NULL, &vigil_compress_gzip_decompress_doc},
    ...
    {"tar_gz_read", 11U, tar_gz_read_fn, 2U, two_bytes_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0, NULL, NULL, 0U,
     compress_data_filename_param_names, NULL, NULL, &vigil_compress_tar_gz_read_doc},
    {"gzip_decompress_max", 19U, gzip_decompress_max_fn, 2U, bytes_int_param, VIGIL_TYPE_STRING, 2U, str_err_returns, 0,
     NULL, NULL, 0U, compress_data_max_bytes_param_names, NULL, NULL, &vigil_compress_gzip_decompress_max_doc},
