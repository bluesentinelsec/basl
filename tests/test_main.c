...
extern void register_gui_tests(void);
extern void register_audio_tests(void);
extern void register_sysquery_tests(void);
...
extern void register_utf8_tests(void);
extern void register_xml_tests(void);
