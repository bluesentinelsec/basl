...
fn main() -> i32 {
    string data = ""
    string compressed, err e1 = compress.zlib_compress(data)
    // empty input returns error, which is expected
    if e1 != ok { return 0 }
    return 1
}'''
        rc, out, err = run_vigil(code)
