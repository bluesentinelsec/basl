...
if(VIGIL_ENABLE_AOT)
    add_subdirectory(deps/mir)
    target_link_libraries(vigil PRIVATE mir_static)
    target_include_directories(vigil PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/deps/mir)
    target_include_directories(vigil_core PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/deps/mir)
    target_compile_definitions(vigil PRIVATE VIGIL_ENABLE_AOT)
    target_compile_definitions(vigil_core PRIVATE VIGIL_ENABLE_AOT)
endif()
